...
{
    public class UsStockQuoteControllerTest
    {
        private readonly Mock<IFinnhubService> _finnhubServiceMock;
        private readonly UsStockQuoteController _sut;

        public UsStockQuoteControllerTest()
        {
            _finnhubServiceMock = new Mock<IFinnhubService>(MockBehavior.Strict);
            _sut = new UsStockQuoteController(_finnhubServiceMock.Object);
        }
